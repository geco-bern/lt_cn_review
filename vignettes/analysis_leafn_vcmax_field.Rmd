...
df_tvals |> 
  ...
  labs(y = expression(italic(t)-value)) +
  theme(
...
ggsave(paste0(here::here(), "/fig/tvals_bars.pdf"), width = 8, height = 5)
ggsave(paste0(here::here(), "/fig/tvals_bars.png"), width = 8, height = 5)
```
...
ggsave(paste0(here::here(), "/fig/coef_bars.pdf"), width = 8, height = 5)
ggsave(paste0(here::here(), "/fig/coef_bars.png"), width = 8, height = 5)
```
