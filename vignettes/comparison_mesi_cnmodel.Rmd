...
gg_mesi_cnmodel_eco2 <- df_box_co2 |> 
  ...
  labs(x = "Variable", 
       ...
       title = expression(paste("Response to eCO"[2])),
       subltitle = "MESI data and cnodel") +
...
gg_mesi_cnmodel_nfert <- df_box_nfert_mesi |> 
  ...
  labs(x = "", 
       y = "Normalised log response ratio",
       title = "Response to N-fertilization",
       subtitle = "MESI data and cnmodel") +
  coord_flip() +
  scale_x_discrete("", labels = mylabl)
...
gg_mesi_cnmodel_nfert <- df_box_nfert_liang |> 
  ...
  labs(x = "", 
       y = "Normalised log response ratio", 
       title = "Response to N-fertilization",
       subtitle = "Liang et al. data and cnmodel") +
  coord_flip() +
  scale_x_discrete("", labels = mylabl)
...
gg_mesi_cnmodel_nfert
ggsave("../fig/liang_cnmodel_nfert.pdf")
```
