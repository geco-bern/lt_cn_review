...
df_box_nfert_liang <- read_rds(paste0(here::here(), "/data/df_boxb_liang_nfert.rds")) |> 
  mutate(var = ifelse(var == "Vcmax", "vcmax",
...
Visualisation of variables from MESI.
```{r}
var_order <- c("anpp", 
               "agb", 
               "root_production", 
...
gg_mesi_cnmodel_nfert <- df_box_nfert_mesi |> 
...
gg_mesi_cnmodel_nfert <- df_box_nfert_liang |> 
  left_join(df_cnmodel_nfert_logresponse, by = "var") |> 
