...
gg_mesi_cnmodel_eco2 <- df_box_co2 |> 
  ...
  coord_flip() +
  ggtitle(expression(bold("Response to CO"[2])), subtitle = "cnmodel vs. MESI data") +
  theme_classic() +
  theme(
...
gg_mesi_cnmodel_nfert_mesi <- df_box_nfert_mesi |> 
  ...
  ggtitle(expression(bold("Response to N")), subtitle = "cnmodel vs.\n MESI + NutNet data") +
  theme_classic() +
  theme(
    plot.title.position = "plot",
    plot.title = element_text( hjust = 0.98, 
