...
- Get more data for root:shoot ratio from N-fertilisation experiments (-> EWAN).
- Get more data for N-inorg. data from N-fertilisation experiments (-> EWAN).
...
- Very few data on belowground biomass response. No estimates available from other experiments, e.g., from NutNet (-> EWAN)
