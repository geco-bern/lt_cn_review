...
use_response <- c("asat", "vcmax", "jmax", "gpp", "leaf_n_area", "leaf_n_mass", "leaf_cn", "anpp", "agb", "leaf_biomass", "lai", "lai_max", "leaf_area", "bgb", "fine_root_biomass", "root_production", "fine_root_production", "root_shoot_ratio", "soil_no3-n", "soil_nh4-n", "soil_nh4", "soil_no3", "soil_solution_nh4", "soil_solution_no3", "root_n_uptake", "root_nh4_uptake", "root_no3_uptake")
...
df3_co2 <- df2 |> 
  ...
  ## keep only essential variables and drop rows containing missing values for essential variables
  select(id, exp, myvar, treatment, sampling_year, c_t, c_c) |> 
...
df4 <- df3 |> 
  left_join(
    df3_co2,
    by = c("id", "exp", "myvar", "sampling_year")
  ) |> 
...
```{r}
show_vars <- c("asat", "gpp", "vcmax", "jmax", "leaf_n_area", "leaf_n_mass", "leaf_cn", "lai", "leaf_area", "leaf_biomass", "anpp", "agb", "root_production", "bgb", "root_shoot_ratio", "n_uptake", "n_inorg")
...
gg_eco2_mesi <- df5 %>%
  ...
  geom_jitter( color = rgb(0,0,0,0.5), aes( size = 1/logr_se ), 
  ...
  labs(title = expression(paste("Response to eCO"[2])),
       subtitle = "MESI data",
       x = "", 
...
df3 <- df2 |> 
  ...
  ## keep only essential variables and drop rows containing missing values for essential variables
  select(id, exp, myvar, treatment, sampling_year, n_t, nfert_lev, x_t, x_c, sd_t, sd_c, rep_t, rep_c) %>% 
