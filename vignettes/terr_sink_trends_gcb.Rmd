...
```{r cars}
df <- read_csv(here::here("data/Global_Carbon_Budget_2021v1.0_tab_terr_sink.csv"))
```
...
ggsave(here::here("fig/sink_trend_trendy.pdf"), width = 1.7*6, height = 1.7*5)
ggsave(here::here("fig/sink_trend_trendy.png"), width = 1.7*6, height = 1.7*5)
